    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <p className="text-base text-gray-700 md:text-lg">
          Courses designed by experts with real-world practice. Join our global
          community.
        </p>
      </div>
      <div className="grid max-w-screen-lg mx-auto space-y-6 lg:grid-cols-2 lg:space-y-0 lg:divide-x">
        <div className="space-y-6 sm:px-16">
          <div className="flex flex-col max-w-md sm:flex-row">
            ...
            <div>
              ...
              <p className="text-sm text-gray-900">
                ...
                functional code within minutes of starting your first course..
              </p>
            </div>
          </div>
          <div className="flex flex-col max-w-md sm:flex-row">
            ...
            <div>
              <h6 className="mb-3 text-xl font-bold leading-5">Bite-sized</h6>
              <p className="text-sm text-gray-900">
                Go step-by-step through our unique courses. Assess what you’ve
                learned with in-lesson quizzes, and gradually advance your
          ...
          <div className="flex flex-col max-w-md sm:flex-row">
            ...
            <div>
              <h6 className="mb-3 text-xl font-bold leading-5">Get proof</h6>
              <p className="text-sm text-gray-900">
                Earn a certificate to validate your newly acquired skills. Post
                it on social for others to see.
              </p>
            </div>
          </div>
        </div>
